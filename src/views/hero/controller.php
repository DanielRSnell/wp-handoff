...
namespace WPHandoff\Components\Hero;

/**
 * Component Controller for Hero
 * 
 ...
 * 
 * The filter 'wp_handoff_component_hero_data' receives the raw field data
 * and allows you to modify it before it reaches the template.
 */
class Controller {
    public function __construct() {
        add_filter('wp_handoff_component_hero_data', [$this, 'processData']);
    }
