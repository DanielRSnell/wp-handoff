<?php
    ...
    // Page Not Found if Index is being user your routing system has failed
...
<html lang="en"><head>
  ...
  <body>
    <div class="main">
      <div class="card">
        <h1>Router Disconnected</h1>
        <p>
          It looks like primary routing for WP Handoff is disconnected. This is likely due to a misconfiguration in your routing system which is located in `./src/templates/router/controller.php`.
        </p>
        <hr>
        <p class="your-site">
