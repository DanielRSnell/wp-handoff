...
class ThemeSetup {
    ...
    private function initializeAdmin() {
        require_once get_template_directory() . '/includes/editor/admin/configure/pages.php';
        require_once get_template_directory() . '/includes/editor/admin/builder/init.php';
